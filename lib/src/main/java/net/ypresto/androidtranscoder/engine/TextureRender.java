...
class TextureRender {
     ...
     */
    public void surfaceCreated(OutputSurface surface1, OutputSurface surface2, Integer outTexture) {
        ...
        GLES20.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, surface1.getTextureID());
